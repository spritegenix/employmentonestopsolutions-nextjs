...
import { email, number, socials } from "@/lib/data"
    ...
    return (
        ...
        <header className={`main-header header-style-three ${scroll ? "fixed-header" : ""}`}>
                    ...
                    <div className="top-inner">
                        <ul className="info">
                            <li>
                                ...
                                Call: <Link href={`"tel:${number}`}>{number}</Link>
                            </li>
                            <li>
                                <img src="assets/images/icons/icon-7.png" alt=""/>
                                Mail: <Link href={`mailto:${email}`}>{email}</Link>
                            </li>
                        </ul>
            ...
            <div className="header-lower">
                <div className="auto-container">
                    <div className="outer-box">
                        <figure className="logo-box"><Link href="/"><img src="/assets/images/employment-one-stop-logo.png" alt="employment-one-stop-logo"/></Link></figure>
            ...
            <div className={`sticky-header ${scroll ? "animated slideInDown" : ""}`}>
                <div className="auto-container">
                    <div className="outer-box">
                        <figure className="logo-box"><Link href="/"><img src="assets/images/employment-one-stop-logo.png" alt=""/></Link></figure>
                        <div className="menu-area">
                            <nav className="main-menu navbar-expand-md navbar-light">
                                <div className="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <Menu />
